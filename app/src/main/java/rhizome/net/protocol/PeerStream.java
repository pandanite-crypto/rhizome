...
public class PeerStream {
    ...
    public PeerStream(AsyncTcpSocket socket,
		...
		ChannelSerializer<Message> serializer = ChannelSerializer.create(messageSerializer)
		...
		ChannelDeserializer<Message> deserializer = ChannelDeserializer.create(messageSerializer);
